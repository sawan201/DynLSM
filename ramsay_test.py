...
def main():
    ...
    sim.run(simName = "BiggerTuned", numberOfSamples = 15000, burnIn = 3000, initType = "truth", randomWalkVariance = 0.01, fixX = False, fixR = False, fixBetaIN = False, fixBetaOUT = False, fixSigmaSq = False, fixTauSq = False)
